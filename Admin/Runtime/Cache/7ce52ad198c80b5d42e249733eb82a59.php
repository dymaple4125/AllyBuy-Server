        ...
        <script>
            $(function(){
               ...
               $('#submit_btn').click(function(e){
                   ...
                   var country_id   =   <?php echo ($country['country_id']); ?>;
                   ...
                   $.post("<?php echo U('update', '', '');?>",{country_id:country_id, country_name:country_name.val()},function(data){
                        //add fail
                        if(data['status']==0){
                            $('#alert_fail').html("更新《"+country_name.val()+"》不成功，请再试");
                            $('#alert_fail').attr('hidden', false);
                        }
                        //add success
                        else if(data['status']==1) { 
                            $('#alert_success').html("更新《"+country_name.val()+"》成功");
    ...
    <!--        header-->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo U('index', '', '');?>">Country</a></li>
                    ...
                    <div class="form-group">
                      ...
                      <p style="color: gray;">#<?php echo ($country['country_id']); ?></p>
                    </div>
                    <div class="form-group">
                      <label for="countryInput">Country Name</label>
                      <input type="text" value="<?php echo ($country['country_name']); ?>" class="form-control" id="country_name_input" name="country_name" placeholder="Add a new country name">
                    </div>
