...
<html>
    <head>
        ...
        <script>
            ...
            var loadURL =   "<?php echo U('viewrecent', '', '');?>";
            ...
            $(function(){
                ...
                var table = $('#datatable').DataTable({
                    ajax: loadURL,//"<?php echo U('viewall', '', '');?>",
                    processing: true,
                    ...
                    "columns": [
                        ...
                        { "data": "deadline", className: "all", defaultContent:"N/A" },
                ...
                $('input[name=check-viewall]').click(function(){
                    //view recent records
                    if($(this).attr('checked')){
                        //alert('checked');
                        $(this).attr('checked', false);
                        loadURL =   "<?php echo U('viewrecent', '', '');?>";
                    }
                    //to viewall records
                    else{
                        //alert('not checked');
                        $(this).attr('checked', true);
                        loadURL =  "<?php echo U('viewall', '', '');?>";
                    }
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="main">
                ...
                <div id="toolpanel" style="margin-top:20px; margin-bottom:20px;">
                    <label><input type="checkbox" name="check-viewall"> 加载所有专业</label>
                </div>
                <div>
