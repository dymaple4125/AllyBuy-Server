            ...
            <div class="row">                
                <div class="main">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo U('district/index','country_id='.$district['country_id'], '');?>"><?php echo ($district['country_name']); ?></a></li>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo ($district['district_name']); ?>" class="form-control" id="district_name_input" name="district_name" placeholder="Add a new district name">
                    </div>
