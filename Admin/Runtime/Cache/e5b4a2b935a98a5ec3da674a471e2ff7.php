            ...
            $(function(){
                ...
                var table = $('#datatable').DataTable({
                    ...
                    "columns": [
                        ...
                        { "mRender": function(data, type, full) {
                                var id  =   full['country_id'];
                                return "<a class='btn btn-info btn-sm' href='<?php echo U('/district/index/country_id/"+id+"', '', '');?>'>Go into</a>";
                            }
                        }
                    ]
                });
                ...
                $('#btn_edit').click(function(){
                   ...
                   if(table.row('.selected').length==0){
                    ...
                    location.href   =   "<?php echo U('/country/edit/country_id/"+id+"', '', '');?>";
                });
                ...
                $('#btn_delete').click( function () {
                    ...
                    $('#remove_modal button[name=remove_btn]').click(function(){
                        ...
                        //post data to delete
                        $.post("<?php echo U('delete', '', '');?>", {country_id:table.cell('.selected', 0).data()},
                        function(data){
                            //delete fail
                            if(data['status']==0)
                            {
