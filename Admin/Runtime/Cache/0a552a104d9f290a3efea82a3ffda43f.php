        ...
        <script>
            $(function(){
               ...
               $('#submit_btn').click(function(e){
                   ...
                   var district_id   =  <?php echo ($nav['district_id']); ?>; 
                   ...
                   $.post("<?php echo U('insert', '', '');?>",{district_id: district_id, university_name:university_name.val()},function(data){
                        //add fail
                        if(data['status']==0){
                            $('#alert_fail').html("添加《"+university_name.val()+"》不成功，请再试");
                            $('#alert_fail').attr('hidden', false);
                        }
                        //add success
                        else if(data['status']==1) { 
                            $('#alert_success').html("添加《"+university_name.val()+"》成功");
            ...
            <div class="row">
                <div class="main">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="university_name_input" name="university_name" placeholder="Add a new university name">
