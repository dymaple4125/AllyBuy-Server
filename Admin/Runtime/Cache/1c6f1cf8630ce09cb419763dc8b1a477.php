        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="<?php echo U('insert', '', '');?>">   
                        <div class="form-group">
                          <label>Service Title</label>
                          <input type="text" class="form-control" id="subject_name_input" name="title" placeholder="Add a new service title">
                        </div>
                        <div class="form-group">
                          <label>Service Description</label>
                          <textarea type="text" class="form-control" id="subject_name_input" name="description" placeholder="Add a new service description"></textarea>
                        </div>
                        <div class="form-group">
                          <label>image</label>
                          <input type="file" name="img">
                          <p class="help-block">上传一个thumb图像，最大不可超过80*80，图小格式必须为PNG,JPG,JPEG</p>
                        </div>
                        <div class="form-group">
                          <label>Quota</label>
                          <input type="text" class="form-control" id="subject_name_input" name="quota" placeholder="奖品一天最多quota">
                        </div>
                        <div class="form-group">
                          <label>Category</label>
                          <input type="text" class="form-control" id="subject_name_input" name="category" placeholder="将奖品分类，例如撰写类奖品为1,书籍奖品为2等">
                        </div>
