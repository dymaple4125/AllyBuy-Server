            ...
            $(function(){
                ...
                var table = $('#datatable').DataTable({
                    ...
                    "ajax": {
                        ...
                        "type": 'POST',
                        "data": {
                            district_id: "<?php echo ($nav['district_id']); ?>"
                        }
                    },
                    ...
                    "columns": [
                        ...
                        { "mRender": function(data, type, full) {
                                var id  =   full['university_id'];
                                return "<a class='btn btn-info btn-sm' href='<?php echo U('/department/index/university_id/"+id+"', '', '');?>'>Go into</a>";
                            }
                        }
                    ]
                });
                ...
                $('#btn_add').click(function(){
                    location.href   =   "<?php echo U('add', 'district_id='.$nav['district_id'], '');?>";
                });
                ...
                $('#btn_edit').click(function(){
                   ...
                   if(table.row('.selected').length==0){
                    ...
                    location.href   =   "<?php echo U('/university/edit/university_id/"+id+"', '', '');?>";
                });
                ...
                $('#btn_delete').click( function () {
                    ...
                    $('#remove_modal button[name=remove_btn]').click(function(){
                        ...
                        //post data to delete
                        $.post("<?php echo U('delete', '', '');?>", {university_id:table.cell('.selected', 0).data()},
                        function(data){
                            //delete fail
                            if(data['status']==0)
                            {
