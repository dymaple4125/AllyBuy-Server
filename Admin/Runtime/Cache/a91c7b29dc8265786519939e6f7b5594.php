            ...
            $(function(){
               ...
               $('#submit_btn').click(function(e){
                   ...
                   $.post("<?php echo U('insert', '', '');?>",values,function(data){
                        //add fail
                        if(data['status']==0){
                            $('#alert_fail').html("添加新的用户资料不成功，请再试");
                            $('#alert_fail').attr('hidden', false);
                        }
                        //add success
                        else if(data['status']==1) { 
                            $('#alert_success').html("添加新的用户资料成功");
                ...
                <div class="main">
                    ...
                    <div class="form-group">
                      ...
                      <select id="country_select" class="form-control">
                            <?php if(is_array($country_list)): foreach($country_list as $key=>$country): if($country['country_id'] == 0): ?><option selected value="<?php echo ($country['country_id']); ?>"><?php echo ($country['country_name']); ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <select id="subject_select" class="form-control">
                            <?php if(is_array($subject_list)): foreach($subject_list as $key=>$subject): if($subject['subject_id'] == 0): ?><option selected value="<?php echo ($subject['subject_id']); ?>"><?php echo ($subject['subject_name']); ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <select id="experience_select" class="form-control">
                            <?php if(is_array($experience_list)): foreach($experience_list as $key=>$experience): if($experience['experience_id'] == 0): ?><option selected value="<?php echo ($experience['experience_id']); ?>"><?php echo ($experience['experience_name']); ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <select id="background_select" class="form-control">
                            <?php if(is_array($background_list)): foreach($background_list as $key=>$background): if($background['background_id'] == 0): ?><option selected value="<?php echo ($background['background_id']); ?>"><?php echo ($background['background_name']); ?></option>
                    ...
                    <div class="form-group">
                      <label>TOEFL</label>
                      <input type="text" class="form-control" name="TOEFL" placeholder="TOEFL value">
                    </div>
                    <div class="form-group">
                      <label>IELTS</label>
                      <input type="text" class="form-control" name="IELTS" placeholder="IELTS value">
                    </div>
                    <div class="form-group">
                      <label>GRE</label>
                      <input type="text" class="form-control" name="GRE" placeholder="GRE value">
                    </div>
                    <div class="form-group">
                      <label>GMAT</label>
                      <input type="text" class="form-control" name="GMAT" placeholder="GMAT value">
                    </div>
                    <div class="form-group">
                      <label>GPA</label>
                      <input type="text" class="form-control" name="GPA" placeholder="GPA value">
                    </div>
                </div>
            </div>
        </div>
