        ...
        <script>
            $(function(){
               ...
               $('#submit_btn').click(function(e){
                   ...
                   $.post("<?php echo U('update', '', '');?>",{experience_id:experience_id, experience_name:experience_name.val()},function(data){
                        //add fail
                        if(data['status']==0){
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-10 col-md-10 main">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo U('viewall');?>">experience</a></li>
                    ...
                    <div class="form-group">
                      ...
                      <p style="color: lightgray;">#<?php echo ($experience['experience_id']); ?></p>
                    </div>
                    <div class="form-group">
                      <label for="experienceInput">Experience Name</label>
                      <p style="color: gray;"><?php echo ($experience['experience_name']); ?></p>
                    </div>
                </div>
            </div>
        </div>
