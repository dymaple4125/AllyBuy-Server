        ...
        <script>
            $(function(){
               ...
               $('#submit_btn').click(function(e){
                   ...
                   var background_id   =   <?php echo ($background['background_id']); ?>;
                   ...
                   $.post("<?php echo U('update', '', '');?>",{background_id:background_id, background_name:background_name.val()},function(data){
                        //add fail
                        if(data['status']==0){
                            $('#alert_fail').html("更新《"+background_name.val()+"》不成功，请再试");
                            $('#alert_fail').attr('hidden', false);
                        }
                        //add success
                        else if(data['status']==1) { 
                            $('#alert_success').html("更新《"+background_name.val()+"》成功");
    ...
    <!--        header-->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo U('index');?>">Background</a></li>
                    ...
                    <div class="form-group">
                      ...
                      <p style="color: gray;">#<?php echo ($background['background_id']); ?></p>
                    </div>
                    <div class="form-group">
                      <label for="backgroundInput">Background Name</label>
                      <input type="text" value="<?php echo ($background['background_name']); ?>" class="form-control" id="background_name_input" name="background_name" placeholder="Add a new background name">
                    </div>
