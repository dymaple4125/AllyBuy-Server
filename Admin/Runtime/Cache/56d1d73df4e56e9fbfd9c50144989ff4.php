        ...
        <script>
            $(function(){
               ...
               $('#submit_btn').click(function(e){
                   ...
                   var experience_id   =   <?php echo ($experience['experience_id']); ?>;
                   ...
                   $.post("<?php echo U('update', '', '');?>",{experience_id:experience_id, experience_name:experience_name.val(), value:value.val()},function(data){
                        //add fail
                        if(data['status']==0){
                            $('#alert_fail').html("更新《"+experience_name.val()+"》不成功，请再试");
                            $('#alert_fail').attr('hidden', false);
                        }
                        //add success
                        else if(data['status']==1) { 
                            $('#alert_success').html("更新《"+experience_name.val()+"》成功");
            ...
            <div class="row">                
                <div class="main">
                    ...
                    <div class="form-group">
                      ...
                      <p style="color: gray;">#<?php echo ($experience['experience_id']); ?></p>
                    </div>
                    <div class="form-group">
                      <label for="experienceInput">Experience Name</label>
                      <input type="text" value="<?php echo ($experience['experience_name']); ?>" class="form-control" id="experience_name_input" name="experience_name" placeholder="Add a new experience name">
                    </div>
                    <div class="form-group">
                      <label for="experienceInput">Value</label>
                      <input type="text" value="<?php echo ($experience['value']); ?>" class="form-control" id="experience_name_input" name="value" placeholder="input actual value of this experience">
                    </div>
