        ...
        <script>
            $(function(){
               ...
               $('#submit_btn').click(function(e){
                   ...
                   $.post("<?php echo U('update', '', '');?>",{category_id:category_id, category_name:category_name.val(), category_desc:category_desc.val()},function(data){
                        //add fail
                        if(data['status']==0){
                            $('#alert_fail').html("更新《"+category_name.val()+"》不成功，请再试");
                            $('#alert_fail').attr('hidden', false);
                        }
                        //add success
                        else if(data['status']==1) {
                            $('#alert_success').html("更新《"+category_name.val()+"》成功");
    ...
    <!--        header-->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo U('index');?>">category</a></li>
                    ...
                    <div class="form-group">
                      ...
                      <p style="color: gray;">#<?php echo ($category['category_id']); ?></p>
                    </div>
                    <div class="form-group">
                      <label for="categoryInput">category Name</label>
                      <input type="text" value="<?php echo ($category['category_name']); ?>" class="form-control" id="category_name_input" name="category_name" placeholder="Add a new category name">
                    </div>
                    <div class="form-group">
