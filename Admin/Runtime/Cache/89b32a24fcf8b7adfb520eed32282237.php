            ...
            $(function(){
                ...
                var table = $('#datatable').DataTable({
                    ...
                    columns: [
                        ...
                        { "mRender": function(data, type, full) {
                                var img  =   full['img'];
                                return "<img height='50' src='__ROOT__/public/uploads/service/s_"+img+"'>";
                                //return "<a href='__ROOT__/public/uploads/service/s_"+img+"' target='_blank'>"+img+"</a>";
                            }
                        },
                        { data: "quota"},
                        { data: "category"},
                ...
                $('#btn_edit').click(function(){
                   ...
                   if(table.row('.selected').length==0){
                    ...
                    location.href   =   "<?php echo U('/service/edit/service_id/"+id+"', '', '');?>";
                });
                ...
                $('#btn_delete').click( function () {
                    ...
                    $('#remove_modal button[name=remove_btn]').click(function(){
                        ...
                        //post data to delete
                        $.post("<?php echo U('delete', '', '');?>", {service_id:table.cell('.selected', 0).data()},
                        function(data){
                            //delete fail
                            if(data['status']==0)
                            {
