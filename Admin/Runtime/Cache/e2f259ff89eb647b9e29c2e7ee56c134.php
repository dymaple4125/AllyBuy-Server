        ...
        <script>
            $(function(){
               ...
               $('#submit_btn').click(function(e){
                   ...
                   var subject_id   =   <?php echo ($subject['subject_id']); ?>;
                   ...
                   $.post("<?php echo U('update', '', '');?>",{subject_id:subject_id, subject_name:subject_name.val()},function(data){
                        //add fail
                        if(data['status']==0){
                            $('#alert_fail').html("更新《"+subject_name.val()+"》不成功，请再试");
                            $('#alert_fail').attr('hidden', false);
                        }
                        //add success
                        else if(data['status']==1) { 
                            $('#alert_success').html("更新《"+subject_name.val()+"》成功");
...
<!--        header-->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="main">
                    <ol class="breadcrumb">
                        <li><a href="<?php echo U('index');?>">Subject</a></li>
                    ...
                    <div class="form-group">
                      ...
                      <p style="color: gray;">#<?php echo ($subject['subject_id']); ?></p>
                    </div>
                    <div class="form-group">
                      <label for="subjectInput">Subject Name</label>
                      <input type="text" value="<?php echo ($subject['subject_name']); ?>" class="form-control" id="subject_name_input" name="subject_name" placeholder="Add a new subject name">
                    </div>
